...
```json
"features": {
    "ghcr.io/mpriscella/devcontainers-features/dotnet:2": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/mpriscella/devcontainers-features/blob/main/src/dotnet/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
